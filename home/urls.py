...
from .views import (HomeView, PostDetailView, PostDeleteView, PostUpdateView, CreatePostView, PostAddReplyView,
                    PostLikeView)
...
urlpatterns = [
    ...
    path('reply/<int:post_id>/<int:comment_id>/', PostAddReplyView.as_view(), name='add_reply'),
